...
Paquete: `rlvgl-chips-microchip`

Proporciona una base de datos de placas para dispositivos Microchip utilizada por `rlvgl-creator`.
...
y el chip asociado. Futuras versiones pueden incluir información del paquete y compensaciones
