...
//
// Generated by `rlvgl-creator qt emit --target rlvgl` from `tests/fixtures/qt/multi/b.qml`.
...
pub const QT_SOURCE: &str = "tests/fixtures/qt/multi/b.qml";
...
pub fn build_screen(
    ...
    let node = build_b(bounds, Rc::clone(&state), &mut label_bindings);
