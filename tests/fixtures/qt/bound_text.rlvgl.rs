...
//
// Generated by `rlvgl-creator qt emit --target rlvgl` from `tests/fixtures/qt/bound_text.qml`.
...
fn build_root(
    ...
    node.children.push(build_node_1(child_bounds, Rc::clone(&state), label_bindings));
    node
}
