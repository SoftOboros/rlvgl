//! Generated SCXML state machine crate: `ScxmlInteractiveDiningPhilosophers`.
//!
...
pub enum MachineState {
    /// State `InteractiveDiningPhilosophers`.
    InteractiveDiningPhilosophers,
    /// State `P1`.
    P1,
    /// State `P1_Empty`.
    P1_Empty,
...
impl MachineState {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            MachineState::InteractiveDiningPhilosophers => "InteractiveDiningPhilosophers",
            MachineState::P1 => "P1",
            MachineState::P1_Empty => "P1_Empty",
            MachineState::P1_Thinking => "P1_Thinking",
            MachineState::P1_Hungry => "P1_Hungry",
            MachineState::P1_HasLeft => "P1_HasLeft",
            MachineState::P1_Eating => "P1_Eating",
            MachineState::P1_Recover => "P1_Recover",
            MachineState::P2 => "P2",
            MachineState::P2_Empty => "P2_Empty",
            MachineState::P2_Thinking => "P2_Thinking",
            MachineState::P2_Hungry => "P2_Hungry",
            MachineState::P2_HasLeft => "P2_HasLeft",
            MachineState::P2_Eating => "P2_Eating",
            MachineState::P2_Recover => "P2_Recover",
            MachineState::P3 => "P3",
            MachineState::P3_Empty => "P3_Empty",
            MachineState::P3_Thinking => "P3_Thinking",
            MachineState::P3_Hungry => "P3_Hungry",
            MachineState::P3_HasLeft => "P3_HasLeft",
            MachineState::P3_Eating => "P3_Eating",
            MachineState::P3_Recover => "P3_Recover",
            MachineState::P4 => "P4",
            MachineState::P4_Empty => "P4_Empty",
            MachineState::P4_Thinking => "P4_Thinking",
            MachineState::P4_Hungry => "P4_Hungry",
            MachineState::P4_HasLeft => "P4_HasLeft",
            MachineState::P4_Eating => "P4_Eating",
            MachineState::P4_Recover => "P4_Recover",
            MachineState::P5 => "P5",
            MachineState::P5_Empty => "P5_Empty",
            MachineState::P5_Thinking => "P5_Thinking",
            MachineState::P5_Hungry => "P5_Hungry",
            MachineState::P5_HasLeft => "P5_HasLeft",
            MachineState::P5_Eating => "P5_Eating",
            MachineState::P5_Recover => "P5_Recover",
    ...
    pub fn from_id(id: &str) -> Self {
        match id {
            "InteractiveDiningPhilosophers" => MachineState::InteractiveDiningPhilosophers,
            "P1" => MachineState::P1,
            "P1_Empty" => MachineState::P1_Empty,
            "P1_Thinking" => MachineState::P1_Thinking,
            "P1_Hungry" => MachineState::P1_Hungry,
            "P1_HasLeft" => MachineState::P1_HasLeft,
            "P1_Eating" => MachineState::P1_Eating,
            "P1_Recover" => MachineState::P1_Recover,
            "P2" => MachineState::P2,
            "P2_Empty" => MachineState::P2_Empty,
            "P2_Thinking" => MachineState::P2_Thinking,
            "P2_Hungry" => MachineState::P2_Hungry,
            "P2_HasLeft" => MachineState::P2_HasLeft,
            "P2_Eating" => MachineState::P2_Eating,
            "P2_Recover" => MachineState::P2_Recover,
            "P3" => MachineState::P3,
            "P3_Empty" => MachineState::P3_Empty,
            "P3_Thinking" => MachineState::P3_Thinking,
            "P3_Hungry" => MachineState::P3_Hungry,
            "P3_HasLeft" => MachineState::P3_HasLeft,
            "P3_Eating" => MachineState::P3_Eating,
            "P3_Recover" => MachineState::P3_Recover,
            "P4" => MachineState::P4,
            "P4_Empty" => MachineState::P4_Empty,
            "P4_Thinking" => MachineState::P4_Thinking,
            "P4_Hungry" => MachineState::P4_Hungry,
            "P4_HasLeft" => MachineState::P4_HasLeft,
            "P4_Eating" => MachineState::P4_Eating,
            "P4_Recover" => MachineState::P4_Recover,
            "P5" => MachineState::P5,
            "P5_Empty" => MachineState::P5_Empty,
            "P5_Thinking" => MachineState::P5_Thinking,
            "P5_Hungry" => MachineState::P5_Hungry,
            "P5_HasLeft" => MachineState::P5_HasLeft,
            "P5_Eating" => MachineState::P5_Eating,
            "P5_Recover" => MachineState::P5_Recover,
...
/// SCXML state machine executor for `ScxmlInteractiveDiningPhilosophers`.
///
/// Usage:
/// ```ignore
...
mod tests {
    ...
    fn test_dispatch_first_event() {
        ...
        // (break.1) and verify the machine reaches a non-empty state.
        let mut m = Machine::new();
        m.start();
        ...
        m.step("break.1", Value::Undefined);

        let state_after = m.current_state().to_string();
        eprintln!("State after dispatching 'break.1': {}", state_after);
        assert!(
