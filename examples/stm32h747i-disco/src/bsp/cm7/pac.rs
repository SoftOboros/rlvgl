...
pub fn init_power(dp: &pac::Peripherals) {
    ...
    let supply = {
        // From .ioc: PWR.Supply = SMPS
        Supply::SMPS
    };
    let vos = {
        // From .ioc: PWR.SDLEVEL = VOS1
        Vos::VOS1
    };
...
pub fn init_clocks(dp: &pac::Peripherals) {
    // Parsed from .ioc (raw tokens): SYSCLK=none, PLLSRC=none
    // Prescalers: D1CPU=none, D1PPRE=none, D2PPRE1=none, D2PPRE2=none, D3PPRE=none
    // HSE: none Hz
    ...
    let pllsrc_bits: u32 = match NONE {
        "HSE" | "RCC_PLLSOURCE_HSE" => 0b10,
        "CSI" | "RCC_PLLSOURCE_CSI" => 0b01,
        _ => 0b00,
    };
    // DIVM1 from `.ioc` PLL1
    let divm1: u32 = 5 as u32 & 0x3F;
    ...
    let n1: u32 = (48 as u32).saturating_sub(1) & 0x1FF;
    let p1: u32 = (2 as u32).saturating_sub(1) & 0x7F;
    let q1: u32 = (5 as u32).saturating_sub(1) & 0x7F;
    let r1: u32 = (2 as u32).saturating_sub(1) & 0x7F;
    ...
    let d1cpre_bits: u32 = match "none" {
    ...
    let d1ppre_bits: u32 = match "none" {
    ...
    let d2ppre1_bits: u32 = match "none" {
    ...
    let d2ppre2_bits: u32 = match "none" {
    ...
    let d3ppre_bits: u32 = match "none" {
