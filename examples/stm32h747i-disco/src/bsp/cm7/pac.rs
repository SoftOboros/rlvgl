...
use board::{DEFAULT_PWR_SUPPLY, DEFAULT_VOS, Supply, Vos};
...
pub fn init_power(dp: &pac::Peripherals) {
    ...
    match supply {
        Supply::SMPS => {
            ...
            dp.PWR
                .cr3
                .modify(|_, w| w.sden().set_bit().ldoen().clear_bit());
        ...
        Supply::LDO => {
            dp.PWR
                .cr3
                .modify(|_, w| w.ldoen().set_bit().sden().clear_bit());
        }
    }
...
pub fn init_clocks(_dp: &pac::Peripherals) { /* disabled for bring-up */
}
