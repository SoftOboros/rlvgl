...
use stm32h7xx_hal::{gpio::Speed, pac, prelude::*, gpioa::*, gpiob::*, gpioc::*, gpiod::*, gpioe::*, gpiof::*, gpiog::*, gpioh::*, gpioi::*, gpioj::*, gpiok::*};
...
pub fn configure_pins_hal(dp: &pac::Peripherals) {
    ...
    // PA10 USART1_RX AF7 (STLINK_TX)let pa10 =                      gpioa.pa10.into_alternate::<7>()
    ;
    ...
    // PA9 USART1_TX AF7 (STLINK_RX)let pa9 =                      gpioa.pa9.into_alternate::<7>()
    ;
