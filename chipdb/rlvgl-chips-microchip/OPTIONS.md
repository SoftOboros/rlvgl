<!--
OPTIONS.md - Cargo feature reference for the rlvgl-chips-microchip crate.
-->
# rlvgl-chips-microchip Options

`rlvgl-chips-microchip` packages Microchip board metadata for creator and
