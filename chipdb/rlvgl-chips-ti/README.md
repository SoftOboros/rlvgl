<!--
README.md - Publish-facing overview for the rlvgl-chips-ti crate.
-->

# rlvgl-chips-ti
Package: `rlvgl-chips-ti`

`rlvgl-chips-ti` is the Texas Instruments board catalog crate used by
`rlvgl-creator` and related code-generation tooling.

## What It Provides

- `vendor()` returning the stable vendor key: `"ti"`
