<!--
OPTIONS.md - Cargo feature reference for the rlvgl-chips-nxp crate.
-->
# rlvgl-chips-nxp Options

`rlvgl-chips-nxp` packages NXP board metadata for creator and board-selection
workflows.
