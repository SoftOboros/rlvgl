<!--
OPTIONS.md - Cargo feature reference for the rlvgl-chips-nrf crate.
-->
# rlvgl-chips-nrf Options

`rlvgl-chips-nrf` packages Nordic Semiconductor board metadata for creator and
