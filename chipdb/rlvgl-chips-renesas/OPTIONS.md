<!--
OPTIONS.md - Cargo feature reference for the rlvgl-chips-renesas crate.
-->
# rlvgl-chips-renesas Options

`rlvgl-chips-renesas` packages Renesas board metadata for creator and
