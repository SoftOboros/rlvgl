<!--
OPTIONS.md - Cargo feature reference for the rlvgl-chips-silabs crate.
-->
# rlvgl-chips-silabs Options

`rlvgl-chips-silabs` packages Silicon Labs board metadata for creator and
