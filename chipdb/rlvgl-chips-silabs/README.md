<!--
README.md - Publish-facing overview for the rlvgl-chips-silabs crate.
-->

# rlvgl-chips-silabs
Package: `rlvgl-chips-silabs`

`rlvgl-chips-silabs` is the Silicon Labs board catalog crate used by
`rlvgl-creator` and related code-generation tooling.

## What It Provides

- `vendor()` returning the stable vendor key: `"silabs"`
