...
This crate expects board definition files extracted by [`tools/st_extract_af.py`](../../tools/st_extract_af.py). During the build, set the
...
- Optional `serde` support for serializing the board database: enable the
