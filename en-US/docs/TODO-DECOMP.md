...
- Stream bytes:
  ...
  - `0xFD` (long repeat): repeat most recent palette index colour for `61 + next_byte` pixels (up to 316).
...
- Encoder improvements
  ...
  - [ ] Mixed strategy for non-palette colours: small local palette vs inline pixels heuristic.
...
- Documentation
  ...
  - [ ] Creator usage docs and troubleshooting (colour banding, palette sizing, thresholds).
