...
| [x] | 3 | T-03 | **Style builder tests** – builder pattern produces expected structs and default fallbacks | T-01 | Automated |
| [x] | 4 | T-04 | **Dummy DisplayDriver and Renderer smoke test** – render a solid-colour frame into a RAM buffer | TODO#3 | Automated (headless) |
...
| [x] | 8 | T-08 | **Layout stress test** – fuzz container sizes and assert no panic / wrong bounds | T-07 | Automated |
| [x] | 9 | 9 | **Simulator backend window test** – open SDL/pixels window and render frame | TODO#5 | Automated (CI headless-X) |
| [x] | 10 | T-10 | **Tier-2 widget goldens** – Checkbox, Slider, Arc, List, Image | TODO#6, T-09 | Automated |
| [x] | 11 | T-11 | **Theme application test** – light/dark theme cascade correctness | TODO#7, T-10 | Automated |
...
| [ ] | 13 | T-13 | **LVGL parity demo diff** – render C demo and rlvgl, perceptual image diff ≤ ε | TODO#9, T-10 | Automated (CI) + **Human** on diff > ε |
| [x] | 14 | T-14 | **Event fuzz regression** – random taps/drags against widgets for 1k iterations with MIRI | T-07 | Automated |
...
| [ ] | 17 | T-17 | **Performance benchmark** – FPS @ 240×320 on desktop and H7 board | T-09, T-06 | **Human-assisted** (hardware timing) |
...
| [x] | 25 | T-25 | **AFDB catalogue builder smoke** – verify pin mappings and GPIO IOModes in generated catalogue | T-24 | Automated |
...
- **Human** – requires eyeballs or physical measurements; try to downscope to sign-off only where unavoidable.
- **Human-assisted** – metrics collected automatically but still need manual interpretation or hardware setup.

> As new TODO items are added, append corresponding tests here, wire them into the dependency chain, and leave the checkbox empty until the test is fully green in CI (or human-verified where applicable).
