...
see [Dockerfile](../../Dockerfile) and [setup-ci-env.sh](../../scripts/setup-ci-env.sh) for an understanding of the complete set of packages used for execution.

If unavailable, rlottie can be built from source as follows:
```bash
...
(.vscode/launch.json)[../../../.vscode/launch.json] contains settings to execute under macOS on x86
