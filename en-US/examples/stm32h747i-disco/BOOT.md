...
This file summarizes the essential status, decisions, and next steps for the CM7 bring-up of the STM32H747I-DISCO target in this repository.
...
- Memory allocation: keep the default heap/stack in DTCM and introduce a second allocator backed by `SDRAM`
  ...
  - Back it with a Rust static using `#[link_section = ".sdram_heap"]` and initialize a dedicated `Heap`/bump allocator
