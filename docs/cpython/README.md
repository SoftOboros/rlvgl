...
close-fence stress validation. Its representative v3 native workload is
implemented but not yet measured on clean host/BBB sources. CPY-03 through
CPY-09 remain Draft and separately evidence-gated.
