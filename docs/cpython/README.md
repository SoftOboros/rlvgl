...
**Status:** CPY-00 through CPY-02 ratified 2026-08-18. CPY-03 has an
implemented bounded native service, Unix readiness, and retained v1/v2 host
capacity matrices; CPY-03 through CPY-09 remain Draft and separately
evidence-gated.
...
| [CPY-03](CPY-03-NATIVE-RUNTIME-SERVICE.md) | Native runtime thread, bounded queues, lifecycle, and callback isolation | Draft; service/readiness and v1/v2 host matrices complete; semantic-workload/board capacity measurement open |
