...
close-fence stress validation. Its representative v3 native workload and
clean-source host matrix are complete; physical BBB qualification remains
open. CPY-03 through CPY-09 remain Draft and separately evidence-gated.
...
| [CPY-03](CPY-03-NATIVE-RUNTIME-SERVICE.md) | Native runtime thread, bounded queues, lifecycle, and callback isolation | Draft; representative v3 host matrix retained; physical BBB qualification open |
