...
close-fence stress validation. CPY-03 through CPY-09 remain Draft and
...
| [CPY-03](CPY-03-NATIVE-RUNTIME-SERVICE.md) | Native runtime thread, bounded queues, lifecycle, and callback isolation | Draft; policy, restart/epoch, and close-fence proofs complete; representative host/BBB workload evidence open |
