...
- **2026-06-13** — LPAR-11c landed `widgets::line::Line`, backed by a borrowed
  point slice with concrete pixel offsets, optional y inversion, layout
  `set_bounds`, and anti-aliased `stroke_line_aa` drawing. Unit tests cover
