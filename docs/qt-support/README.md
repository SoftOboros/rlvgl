...
| `QT-05i` | [`05i-chained-predicate-bindings.md`](./05i-chained-predicate-bindings.md) — rlvgl emit: chained state-predicate → Image-source bindings (repeat-mode icon); shuffle/repeat region remodel | normative — ratified; implementation shipped (host-verified) |
