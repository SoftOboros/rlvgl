...
| `QT-05h` | [`05h-visibility-bindings.md`](./05h-visibility-bindings.md) — rlvgl emit: state-predicate → widget visibility (`visible: <ctx>.<state>`); mute region remodel | normative — ratified (concepts); implementation in progress |
