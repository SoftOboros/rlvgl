...
- `rlvgl-core` moves to `0.2.5`; its image decoders and the `rlvgl-platform`
  simulator use fixed-size slice chunks, clearing the refreshed nightly Clippy
  gate without changing pixel-buffer behavior.
