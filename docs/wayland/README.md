...
implementation and deterministic evidence are authored; Linux compositor and
remaining lifecycle evidence are still open, so WLD-02 remains gated. Target
release line: rlvgl v0.2.7.
...
| [WLD-01](WLD-01-SESSION-SHM-PRESENTATION.md) | Wayland session, XDG lifecycle, SHM buffers, damage, pacing, and release-safe presentation | **Ratified** 2026-08-18; first implementation and deterministic evidence authored; Linux runtime exit evidence pending |
