...
| Phase | Scope | Status |
|---|---|---|
| [WLD-00](WLD-00-CONCEPTS.md) | Authority, profiles, invariants, dependency boundaries, and phase plan | Draft; PCDN-WLD-001 and PCDN-WLD-002 resolved, with three PCDNs open |
