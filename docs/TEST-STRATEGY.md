<!-- TEST-STRATEGY.md - Testing workstream. -->
<p align="center">
...
| [x] | 19 | T-19 | **Vendor board enumeration** – consolidate vendor crates into a unified list | CHIP-SUPPORT | Automated |
...
| [x] | 22 | T-22 | **Chip DB env wiring** – build embeds board definitions from `RLVGL_CHIP_SRC` | CHIP-SUPPORT | Automated |
| [x] | 23 | T-23 | **Publish script chip crates** – release script lists chipdb crates | T-22 | Automated |
| [x] | 24 | T-24 | **AFDB MCU/IP ingest tests** – round-trip sample STM32 XML through canonical overlays | CHIP-SUPPORT | Automated |
