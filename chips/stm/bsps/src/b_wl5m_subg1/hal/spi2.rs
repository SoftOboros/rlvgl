...
pub fn configure_pins_hal(dp: &pac::Peripherals) {
    ...
    // PA10 SPI2_MOSI AF0
    let pa10 = gpioa.pa10.into_alternate::<0>().set_speed(Speed::VeryHigh);
