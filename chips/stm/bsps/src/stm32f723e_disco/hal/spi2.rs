...
pub fn configure_pins_hal(dp: &pac::Peripherals) {
    ...
    // PC2 SPI2_MISO AF0
    let pc2 = gpioc.pc2.into_alternate::<0>().set_speed(Speed::VeryHigh);

    // PC3 SPI2_MOSI AF0
    let pc3 = gpioc.pc3.into_alternate::<0>().set_speed(Speed::VeryHigh);
