...
use stm32u5xx_hal::{gpio::Speed, gpiob::*, gpiog::*, pac, prelude::*};
...
pub fn configure_pins_hal(dp: &pac::Peripherals) {
    ...
    // PG10 SPI3_MISO AF0
    let pg10 = gpiog.pg10.into_alternate::<0>().set_speed(Speed::VeryHigh);

    // PG9 SPI3_SCK AF0
    let pg9 = gpiog.pg9.into_alternate::<0>().set_speed(Speed::VeryHigh);
}
