...
use stm32f4xx_hal::{gpio::Speed, gpioe::*, pac, prelude::*};
...
pub fn configure_pins_hal(dp: &pac::Peripherals) {
    ...
    // PE2 SPI4_SCK AF0
    let pe2 = gpioe.pe2.into_alternate::<0>().set_speed(Speed::VeryHigh);

    // PE5 SPI4_MISO AF0
    let pe5 = gpioe.pe5.into_alternate::<0>().set_speed(Speed::VeryHigh);
