...
pub fn enable_gpio_clocks(dp: &pac::Peripherals) {
    ...
    {
        let _ = dp;
        unsafe { super::super::c_ffi::c_spi2_enable_gpio_clocks(); }
    }
...
pub fn configure_pins_pac(dp: &pac::Peripherals) {
    ...
    {
        let _ = dp;
        unsafe { super::super::c_ffi::c_spi2_configure_pins(); }
    }
    #[cfg(not(feature = "c_hal"))]
    {
        // GPIOA
...
pub fn enable_peripherals(_dp: &pac::Peripherals) {
    #[cfg(feature = "c_hal")]
    unsafe { super::super::c_ffi::c_spi2_enable_peripherals(); }
}
...
pub fn deinit_board_pac(dp: &pac::Peripherals) {
    ...
    {
        let _ = dp;
        unsafe { super::super::c_ffi::c_spi2_deinit(); }
    }
    #[cfg(not(feature = "c_hal"))]
    {
